...
const API\_URL = process.env.REACT\_APP\_API\_URL;
...
{/\* Header with Title and Logout Button \*/} <div className="flex justify-between items-center mb-4"> <h2 className="text-2xl font-bold">Admin Dashboard</h2> <button
